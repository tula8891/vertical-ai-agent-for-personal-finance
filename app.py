...
def initialize_session():
    ...
    if "session" not in st.session_state:
        connection_params = {
            ...
            "password": st.secrets["rag_connection"]["password"],
            "warehouse": st.secrets["rag_connection"]["warehouse"],
            "database": st.secrets["rag_connection"]["database"],
            "schema": st.secrets["rag_connection"]["schema"],
        }
        try:
